...
data_module = DataModule(system=inverted_pendulum_1, val_split=0, train_batch_size=128, test_batch_size=1024, train_grid_gap=0.05, test_grid_gap=0.01)
...
if not fine_tune:
    ...
    # NN = NeuralNetwork.load_from_checkpoint("CBF_logs/robust_training_maximum_without_nominal_controller/lightning_logs/version_12/checkpoints/epoch=199-step=2200.ckpt",dynamic_system=inverted_pendulum_1, data_module=data_module, require_grad_descent_loss=True)
