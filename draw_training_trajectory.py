...
with open('./masterthesis_test/stable_baseline_logs/run1/without_CBF_trajectory.pickle', 'rb') as f:
...
plt.ylabel('theta')
plt.title("the trajectories during learning process(without CBF)")
plt.show()