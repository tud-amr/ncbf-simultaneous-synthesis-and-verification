...
NN = NeuralNetwork.load_from_checkpoint("saved_models/dubins_car_rotate/checkpoints/epoch=166-step=27221.ckpt", dynamic_system=system, data_module=data_module )
NN.to(device)
