...
class CustomCallback(BaseCallback):
    ...
    def _on_step(self) -> bool:
        ...
        self.logger.record("reward", env.reward)
        self.logger.record("step_executing_time", env.step_executing_time) 
    ...
    def _on_training_end(self) -> None:
        ...
        self.logger.record("training_total_time", self.training_end_time - self.training_start_time)
