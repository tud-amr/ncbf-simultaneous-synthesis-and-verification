...
class TestingDataModule(pl.LightningDataModule):
    def __init__(
        ...
        test_points_num: int = 10000,
        test_index: dict = {0: None, 1: None},
    ):
        super().__init__()
        self.system = system
        self.test_batch_size = test_batch_size
        self.test_points_num = test_points_num
        ...
        self.sql_database = SqlDataSet(self.system.ns, "testing")
...
if __name__ == "__main__":
    ...
    data_module = TestingDataModule(system=inverted_pendulum_1, test_batch_size=128, test_points_num=1000, test_index={0: None, 1: None})
