...
NN = NeuralNetwork.load_from_checkpoint("CBF_logs/robust_training/lightning_logs/version_2/checkpoints/epoch=145-step=1752.ckpt", dynamic_system=inverted_pendulum_1, data_module=data_module)
